...
const announcements = [
  {
    ...
    content: `
      ...
      <img src="${import.meta.env.BASE_URL}assets/tip_code.jpg" alt="Tip Code" style="max-width: 20rem" /><br/>
    `
  },

  {
    ...
    content: `
      ...
      <b>缺陷修复：</b><br/>
      <ul>
        <li>修复 Bangumi 搜索跨模式缓存问题</li>
        <li>修复多人模式出题人断开死锁</li>
        <li>修复多人同步模式在最后一人完成猜测时误报结算异常的问题</li>
        <li>修复退出多人房间后玩家头像丢失的问题</li>
      </ul>
    `
  },
